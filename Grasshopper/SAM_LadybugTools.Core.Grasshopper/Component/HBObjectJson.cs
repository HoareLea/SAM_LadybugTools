...
//        /// </summary>
//        public HBObjectJson()
//          : base("HBObject.Json", "HBObject.Json",
//              "Ladybug Tools HB Object to JSON",
//              "SAM", "LadybugTools")
//        {
//        }
...
//        {
//            inputParamManager.AddGenericParameter("_HB Object", "_HB Object", "Ladybug Tools HB Object", GH_ParamAccess.item);
...
//            string json = Core.LadybugTools.Query.ToJson(@object);
//            if(json == null)
//            {
//                dataAccess.SetData(1, false);
//                return;
